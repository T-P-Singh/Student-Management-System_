...
<body>
    <div>
        <marquee ><h1 style="color:rgb(9, 9, 9);font-family: cursive;font-size: 35px; ">Welcome To Edit Student Page</h1></marquee>
        <form action="update_student.jsp" method="post">
            <label class="roll" for="roll">Roll no. :</label>
            <input class="roll1" type="text" name="rollforbackend" id="roll" placeholder="Enter your roll no." required autofocus>
