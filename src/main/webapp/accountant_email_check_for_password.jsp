...
<body>
<form action="forgot_password_accountant.jsp" method="post">
 <% 
 		AccountantService accountantService= new  AccountantService(); 
        String email_for_backend =request.getParameter("email_from_frontend");
    	Accountant accountant  =accountantService.getByEmailAll(email_for_backend);
   %>
    				...
    				<marquee ><h1 style="color:white;font-family: cursive;font-size: 35px; ">Welcome To Accountant Update Password Page</h1></marquee>
   				 	<div class="login">
   				 	<%if(accountant!=null){ %>
   			 		<%if(accountant.getEmail().equals(email_for_backend)) { %>
          			 ...
          			 <input class=" input1" type="text" id="user" name="email_from_frontend" placeholder="Enter your email" required autofocus> 
          			 <br><br>
            		...
            		<%} %>
            	<%if(accountant==null){ %>
           			 <h2 style="color:red;font-family: cursive; " class="heading">Wrong Email Address !!</h2>
            		 <a class="wrongback" href="forgot_password_accountant.jsp" >Back</a>
            	<%} %>
        </form>
    </div>
</body>
