...
<head>
    ...
    <title>Admin name confirmation</title>
...
<body>
    ...
    <marquee ><h1 style="color:white;font-family: cursive;font-size: 35px; ">Welcome To Admin Forgot Password Page</h1></marquee>
    <div class="login">
        <form action="admin_change_password.jsp" method="post" >
            <h2 style="color:black;font-family: cursive; " class="heading">Enter Your Details</h2>
            <label class="input" for="user">Name: </label>
            <input class="input input1" type="text" id="user" name="name_from_frontend" placeholder="Enter your name" required autofocus> 
            <br><br>
